...
//--------------------------------------------------------------------------------
// Initiate the game, roll for turn and determan the avtive player
//--------------------------------------------------------------------------------
...
function btnDisabled(btn) {
    ...
    btn.style.border = "2px solid rgb(152, 153, 102)";
...
function stopGame() {
    ...
    //set squares to empty for start
...
function check4Tie() {
    ...
    if(boardState.length >= 9 && check != "That's three in a row, Player 1 wins!" && check != "That's three in a row, Player 2 wins!" ) {
        var txt1 = "oh no! Nobody wins, its a tie!";
        tieSound(); 
        writeMsg(txt1);
        setTimeout(function() {stopGame();}, 300)
    }
}
...
function glowBoard(pos) {
    ...
    for (var i=0;i<squares.length;i++){
        if(i==index0){
            ...
            blink();
            winSound();
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(155,0,0)';}, 100);
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(0,155,0)';}, 200);
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(0,0,155)';}, 300);
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(155,0,0)';}, 400);
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(0,155,0)';}, 500);
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(0,0,155)';}, 600);
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(155,0,0)';}, 700);
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(0,155,0)';}, 800);
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(0,0,155)';}, 900);
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(155,0,0)';}, 1000);
            setTimeout(function() {bg1.style.backgroundColor = '#d7f3f7';}, 1100);
        } else if(i==index1){
            var bg2 = squares[i];
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(0,155,0)';}, 100);
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(0,0,155)';}, 200);
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(155,0,0)';}, 300);
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(0,155,0)';}, 400);
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(0,0,155)';}, 500);
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(155,0,0)';}, 600);
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(0,155,0)';}, 700);
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(0,0,155)';}, 800);
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(155,0,0)';}, 900);
            setTimeout(function() {bg2.style.backgroundColor = 'rgb(0,155,0)';}, 1000);
            setTimeout(function() {bg2.style.backgroundColor = '#d7f3f7';}, 1100);
        } else if (i==index2){
            var bg3 = squares[i];
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(0,0,155)';}, 100);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(155,0,0)';}, 200);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(0,155,0)';}, 300);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(0,0,155)';}, 400);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(155,0,0)';}, 500);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(0,155,0)';}, 600);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(0,0,155)';}, 700);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(155,0,0)';}, 800);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(0,155,0)';}, 900);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(155,0,0)';}, 1000);
...
function blink() {
    ...
    setTimeout(function() {body.style.backgroundColor = 'rgb(50,50,50)';}, 100);
    setTimeout(function() {body.style.backgroundColor = 'rgb(255,255,255)';}, 200);
    setTimeout(function() {body.style.backgroundColor = 'rgb(50,50,50)';}, 300);
    setTimeout(function() {body.style.backgroundColor = 'rgb(255,255,255)';}, 400);
    setTimeout(function() {body.style.backgroundColor = 'rgb(50,50,50)';}, 500);
    setTimeout(function() {body.style.backgroundColor = 'rgb(255,255,255)';}, 600);
    setTimeout(function() {body.style.backgroundColor = 'rgb(50,50,50)';}, 700);
    setTimeout(function() {body.style.backgroundColor = 'rgb(255,255,255)';}, 800);
    setTimeout(function() {body.style.backgroundColor = 'rgb(50,50,50)';}, 900);
    setTimeout(function() {body.style.backgroundColor = 'rgb(255,255,255)';}, 1000);
    setTimeout(function() {body.style.backgroundColor = '#d7f3f7';}, 1100);
}
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
// click events for square elements
//--------------------------------------------------------------------------------
